...
with tab1:
    ...
    if not df1.empty:
        ...
        # Fila 1: Tendencia Global y Origen
        c1, c2 = st.columns(2)
        with c1:
        ...
        # Fila 2: Interanual y Correlación
        c3, c4 = st.columns(2)
        with c3:
            ...
            fig3 = px.line(df_y[df_y['anio'].isin([2023, 2024, 2025])], x='mes', y='fpd2_rate', color=df_y['anio'].astype(str), markers=True)
